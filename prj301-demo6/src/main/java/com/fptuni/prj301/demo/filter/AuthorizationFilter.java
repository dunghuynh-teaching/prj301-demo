 ...
 */
package com.fptuni.prj301.demo.filter;
...
public class AuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            HttpSession ss = request1.getSession();
            
            UserSession us =  (UserSession) ss.getAttribute("usersession");
            
            String path = request1.getPathInfo();
            log(path);
            
            if (path != null && !path.equals("/login") && us == null){
                response1.sendRedirect(request1.getContextPath()+"/Access/login");
                 return;
            }
